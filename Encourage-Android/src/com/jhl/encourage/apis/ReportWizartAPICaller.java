...
public class ReportWizartAPICaller {
	...
	public void invokeSickenssEmotionalApi(String date, String data,
			String description, boolean ics, String latitude, String longitude) {

		RestAdapter restAdapter = EncourageApplication.getRestAdapter();

		SickEmotionReportService service = restAdapter
				.create(SickEmotionReportService.class);
		...
		service.postReport("getSelfReportedData", date, "datetime", "Date", "",
				...
				"self_reported_form", "selfreport_data", icsString,
				JHUtility.getDateTime(), JHUtility.getTimeZoneString(),
				JHAppStateVariables.getLoginTocken(), "postReportWizardDataa",
				addToCCDetails[0], addToCCDetails[1], addToCCDetails[2],
	...
	public void invokeMapApi(String date, String name, String address,
			String description, boolean ics, String latitude, String longitude) {
		...
		service.postReport("getSelfReportedMap", date, "datetime", "Date", "",
				"1", "", name, "varchar", "Event Name", "", "2", "", address,
				"text", "Event Address", "", "3", "", description, "text",
				"Description", "", "4", "", "timeline-map-form",
				"selfreport_map", icsString, JHUtility.getDateTime(),
				JHUtility.getTimeZoneString(),
				JHAppStateVariables.getLoginTocken(), "postReportWizardData",
				addToCCDetails[0], addToCCDetails[1], addToCCDetails[2],
				latitude, longitude, new Callback<SpocResponse>() {
					@Override
					public void success(SpocResponse spocResponse,
	...
	public void invokeImageApi(String date, String name, boolean ics,
			String uploadedfileName, String actualfileName, String latitude,
			String longitude) {
		...
		ImageReportService service = restAdapter
				.create(ImageReportService.class);
		...
		String blob_upload_file = "[{'dtl_file_actualname':{'dtl_file_actualname':'"
				+ uploadedfileName
				+ "','data_type':'documentactualname'},'dtl_file_name':{'dtl_file_name':'"
				+ actualfileName
				+ "','data_type':'filename'},'dtl_file_type':{'dtl_file_type':'image\\/jpeg','data_type':'documenttype'},'text_file_description':{'data_type':'description'},'dtl_file_author':{'data_type':'authorname'},'dtl_file_category':{'data_type':'category'},'blob_upload_file':'"
				+ uploadedfileName + "'}]";
		// blob_upload_file = StringEscapeUtils.unescapeJava(blob_upload_file);

		System.out.println(" blob_upload_file " + blob_upload_file);

		// service.postReport("getSelfReportedImage", date, "datetime", "Date",
		// "","1", "", name, "varchar", "Event Name", "", "2","",
		// "timeline-image-form", "selfreport_image",
		// "blob_upload_image",icsString,JHUtility.getDateTime(),
		// JHUtility.getTimeZoneString(), JHAppStateVariables.getLoginTocken(),
		// "postReportWizardData", blob_upload_file,
		...
		String upload_files = "{\"blob_upload_file\":{\"dtl_file_actualname\":{\"dtl_file_actualname\":\""
				+ uploadedfileName
				+ "\",\"data_type\":\"documentactualname\"},\"dtl_file_name\":{\"dtl_file_name\":\"download\",\"data_type\":\"filename\"},\"dtl_file_type\":{\"dtl_file_type\":\"image\\/jpeg\",\"data_type\":\"documenttype\"},\"text_file_description\":{\"data_type\":\"description\"},\"dtl_file_author\":{\"data_type\":\"authorname\"},\"dtl_file_category\":{\"data_type\":\"category\"},\"blob_upload_file\":\""
				+ uploadedfileName + "\"}}";
		...
		JHUploadResponse response = JHUploadResponseParser
				.imageReportStatusParse(responseStr);
